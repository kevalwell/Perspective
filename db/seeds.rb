...
perspective1 =  Perspective.create(title: 'The Perfect Grape', content: 'The Sangiovese grape was perfect in texture and sugar content.', status: 1, experience: [Experience.find_by(title:'"Sangiovese Wine Tasting"')])
